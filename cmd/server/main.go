...
func main() {
	...
	workoutHandler := handler.NewWorkoutHandler(workoutRepo, gymRepo, tcRepo, userRepo, mediaRepo, exerciseRepo, commentRepo, cfg.UploadDir)
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/workouts/{id}/comments", workoutHandler.AddComment)
		r.Post("/workouts/{id}/finish", workoutHandler.FinishSession)
		r.Post("/workouts/sets/{setID}/done", workoutHandler.ToggleSetDone)
		r.Get("/workouts/sets/{setID}/edit", workoutHandler.EditSetRow)
		r.Get("/workouts/sets/{setID}/row", workoutHandler.SetRow)
		r.Post("/workouts/sets/{setID}", workoutHandler.UpdateSet)
